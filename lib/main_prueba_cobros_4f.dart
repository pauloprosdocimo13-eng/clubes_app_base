...
import 'pantallas/pruebas/pantalla_prueba_cobros_4f.dart';
...
Future<void> main() async {
  ...
  if (club == null) {
    runApp(
      const MaterialApp(
        ...
        home: Scaffold(
          body: Center(
            child: Text('No existe clubes/generico en TuSede Central.'),
          ),
        ),
      ),
    );
  ...
  runApp(
    MaterialApp(
      debugShowCheckedModeBanner: false,
      home: PantallaPruebaCobros4F(config: config),
    ),
  );
}
