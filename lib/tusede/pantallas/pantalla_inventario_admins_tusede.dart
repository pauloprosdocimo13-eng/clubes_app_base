          ...
          Container(
            ...
            child: const Row(
              ...
              children: [
                ...
                Expanded(
                  child: Text(
                    'Esta pantalla es solamente de control. '
                    'No crea usuarios, no cambia contraseñas '
                    'y no modifica los permisos actuales '
                    'del club.',
...
class _ChipDato extends StatelessWidget {
  ...
  const _ChipDato({required this.titulo, required this.valor});
