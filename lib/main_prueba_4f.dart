...
import 'pantallas/pruebas/pantalla_prueba_4f.dart';
...
Future<void> main() async {
  ...
  if (!inicializado) {
    runApp(const MaterialApp(
      ...
      home: Scaffold(
        body: Center(child: Text('No se pudo inicializar TuSede Central.')),
      ),
    ));
    return;
  }
  ...
  if (club == null) {
    runApp(const MaterialApp(
      debugShowCheckedModeBanner: false,
      home: Scaffold(
        body: Center(child: Text('No existe clubes/generico en TuSede Central.')),
      ),
    ));
    return;
  }
